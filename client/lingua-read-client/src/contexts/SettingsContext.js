...
const mergeSettings = (data) => ({
  ...
  autoMoveFinishedLessons: data.autoMoveFinishedLessons ?? defaultSettings.autoMoveFinishedLessons,
  ...
  hardcoverSyncEnabled: data.hardcoverSyncEnabled ?? defaultSettings.hardcoverSyncEnabled,
  hasHardcoverApiToken: data.hasHardcoverApiToken ?? defaultSettings.hasHardcoverApiToken,
  hardcoverLastSyncAt: data.hardcoverLastSyncAt ?? defaultSettings.hardcoverLastSyncAt,
  useOpenRouter: data.useOpenRouter ?? defaultSettings.useOpenRouter,
  openRouterApiKey: data.openRouterApiKey || defaultSettings.openRouterApiKey,
  openRouterModel: data.openRouterModel || defaultSettings.openRouterModel,
  openRouterReasoningEnabled: data.openRouterReasoningEnabled ?? defaultSettings.openRouterReasoningEnabled,
  openRouterReasoningEffort: data.openRouterReasoningEffort || defaultSettings.openRouterReasoningEffort,
  openRouterStoryReasoningEnabled: data.openRouterStoryReasoningEnabled ?? defaultSettings.openRouterStoryReasoningEnabled,
  openRouterStoryReasoningEffort: data.openRouterStoryReasoningEffort || defaultSettings.openRouterStoryReasoningEffort,
  openRouterTranslationModel: data.openRouterTranslationModel ?? defaultSettings.openRouterTranslationModel,
  openRouterExplanationModel: data.openRouterExplanationModel ?? defaultSettings.openRouterExplanationModel,
  openRouterStoryModel: data.openRouterStoryModel ?? defaultSettings.openRouterStoryModel,
  openRouterSummarizationModel: data.openRouterSummarizationModel ?? defaultSettings.openRouterSummarizationModel,
  customTranslationPrompt: data.customTranslationPrompt ?? defaultSettings.customTranslationPrompt,
  customExplanationPrompt: data.customExplanationPrompt ?? defaultSettings.customExplanationPrompt,
  customStoryPrompt: data.customStoryPrompt ?? defaultSettings.customStoryPrompt,
  customSummarizationPrompt: data.customSummarizationPrompt ?? defaultSettings.customSummarizationPrompt,
